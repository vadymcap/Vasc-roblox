...
- Release workflow now builds `Vasc.rbxm` and uploads it as a release asset

### Changed

- Release and CI workflows now target the `master` branch
- Added `vasc` to Aftman tools for CI/release builds
...
- All "Failed to read property ... from instance" warnings
...
- `Content` datatype deserialization in some edge cases (temporary fix)
...
[unreleased]: https://github.com/vadymcap/Vasc-roblox/compare/2.0.27...HEAD
[2.0.27]: https://github.com/vadymcap/Vasc-roblox/compare/2.0.26...2.0.27
[2.0.26]: https://github.com/vadymcap/Vasc-roblox/compare/2.0.25...2.0.26
[2.0.25]: https://github.com/vadymcap/Vasc-roblox/compare/2.0.24...2.0.25
